...
export default function WorkingWithArrays() {
    ...
    const [todo, setTodo] = useState({
        ...
        description: "Describe Todo ID = 1",
        due: "2021-09-09",
        completed: false,
    });
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <a id="wd-update-todo-title" href={`${API}/${todo.id}/title/${encodeURIComponent(todo.title)}`} className="btn btn-primary float-end">
                Update Todo</a>
            ...
            <h4>Update description and completed (by todo ID)</h4>
            <p className="text-muted small">ID selects which todo to update on the server.</p>
            <FormControl className="w-25 mb-2" id="wd-update-todo-id"
                value={todo.id}
                onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
            <FormControl as="textarea" rows={2} className="w-75 mb-2" id="wd-todo-description"
                value={todo.description}
                onChange={(e) => setTodo({ ...todo, description: e.target.value })} />
            <a id="wd-update-todo-description" className="btn btn-primary mb-2 d-inline-block"
            ...
            <a id="wd-update-todo-completed" className="btn btn-primary mb-2 d-inline-block"
